            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/book/rateBookReview/' + $('[data-bookslug]').data('bookslug'), data, function (result) {
                            if (result.result) {
                            ...
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    if (result) {
                                        ...
                                        $row.find('.form-input_code').addClass('form-input_error').after('<div' +
                                            ' class="form-error">' + 'Wrong code or phone number!' + '</div>');
                                    } else {
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/book/changeBookStatus/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/book/changeBookStatus/rating/' + $('[data-bookid]').data('bookid'), {
